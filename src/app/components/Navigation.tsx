      ...
      <ul className="flex justify-between items-center">
        ...
        <div className="flex items-center space-x-8">
          ...
          <div className="flex space-x-4 left">
            <li><a href="/" className="hover:underline active:font-bold transition-all">Home</a></li>
            <li><a href="/AllProducts" className="hover:underline active:font-bold transition-all">Products</a></li>
          </div>
        </div>
